...
proton#main#start
    clrf STATUS
F1_SOF equ $ ; UYGULAMA_5.BAS
    movlw 7
    bsf STATUS,5
ram_bank = 1
    movwf ADCON1
    movwf CMCON
F1_000009 equ $ ; IN [UYGULAMA_5.BAS] OUTPUT PORTD
    clrf TRISD
F1_000010 equ $ ; IN [UYGULAMA_5.BAS] INPUT PORTB.0
    bsf TRISB,0
F1_000015 equ $ ; IN [UYGULAMA_5.BAS] DURUM = 0
    bcf STATUS,5
ram_bank = 0
    bcf _B#VR1,0
F1_000016 equ $ ; IN [UYGULAMA_5.BAS] BEKLE = 500
    movlw 1
    movwf BEKLEH
    movlw 244
    movwf BEKLE
F1_000017 equ $ ; IN [UYGULAMA_5.BAS] LED = 1
    movlw 1
    movwf PORTD
F1_000018 equ $ ; IN [UYGULAMA_5.BAS] DELAYMS BEKLE
    movf BEKLEH,W
    movwf PP1H
    movf BEKLE,W
    f@call __DELAY_MS_W_
ANAPROGRAM
F1_000024 equ $ ; IN [UYGULAMA_5.BAS] IF DURUM = 0 THEN LED = LED << 1 : ELSE :LED = LED >> 1
    set@page _LBL__3
    btfsc _B#VR1,0
    goto _LBL__3
    bcf STATUS,0
...
_LBL__3
    ...
    rrf PORTD,F
_LBL__4
F1_000026 equ $ ; IN [UYGULAMA_5.BAS] DELAYMS BEKLE
    movf BEKLEH,W
    movwf PP1H
    movf BEKLE,W
    f@call __DELAY_MS_W_
F1_000027 equ $ ; IN [UYGULAMA_5.BAS] IF LED = 128 THEN DURUM = 1
    movlw 128
    subwf PORTD,W
    set@page _LBL__6
    btfss STATUS,2
    ...
    bsf _B#VR1,0
_LBL__6
F1_000028 equ $ ; IN [UYGULAMA_5.BAS] IF LED = 1 THEN DURUM = 0
    movlw 1
    subwf PORTD,W
    set@page _LBL__8
    btfss STATUS,2
    ...
    bcf _B#VR1,0
_LBL__8
F1_000030 equ $ ; IN [UYGULAMA_5.BAS] GOTO ANAPROGRAM
    f@jump ANAPROGRAM
F1_EOF equ $ ; UYGULAMA_5.BAS
_PBLB__9
    f@jump _PBLB__9
__EOF
