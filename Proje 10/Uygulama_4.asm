...
proton#main#start
    clrf STATUS
F1_SOF equ $ ; UYGULAMA_4.BAS
    movlw 7
    bsf STATUS,5
ram_bank = 1
    movwf ADCON1
    movwf CMCON
F1_000010 equ $ ; IN [UYGULAMA_4.BAS] OUTPUT PORTD
    clrf TRISD
F1_000011 equ $ ; IN [UYGULAMA_4.BAS] INPUT PORTB.0
    bsf TRISB,0
ANAPROGRAM
    bcf STATUS,5
ram_bank = 0
F1_000017 equ $ ; IN [UYGULAMA_4.BAS] TOGGLE LED
    movlw 1
    xorwf PORTD,F
    bsf STATUS,5
ram_bank = 1
    bcf TRISD,0
F1_000018 equ $ ; IN [UYGULAMA_4.BAS] DELAYMS 500
    bcf STATUS,5
ram_bank = 0
    movwf PP1H
    movlw 244
    f@call __DELAY_MS_W_
F1_000023 equ $ ; IN [UYGULAMA_4.BAS] GOTO ANAPROGRAM
    f@jump ANAPROGRAM
F1_EOF equ $ ; UYGULAMA_4.BAS
_PBLB__2
    f@jump _PBLB__2
__EOF
