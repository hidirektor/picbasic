...
proton#main#start
    clrf STATUS
    clrf BPF
F1_SOF equ $ ; DISPLAY_4.BAS
    movlw 7
    bsf STATUS,5
ram_bank = 1
    movwf ADCON1
    movwf CMCON
F1_000011 equ $ ; IN [DISPLAY_4.BAS] OUTPUT PORTD
    clrf TRISD
F1_000012 equ $ ; IN [DISPLAY_4.BAS] OUTPUT PORTE
    clrf TRISE
F1_000021 equ $ ; IN [DISPLAY_4.BAS] CLS
    bcf STATUS,5
ram_bank = 0
    f@call LCD@CLS
F1_000022 equ $ ; IN [DISPLAY_4.BAS] PRINT AT 1,1,"MERHABA"
    movlw 128
    movwf BPFH
    f@call LCD@CRS
    ...
    movlw (_STRLB__1 & 255)
    f@call C@STROUT
F1_000023 equ $ ; IN [DISPLAY_4.BAS] PRINT AT 2,1,"MEKATRONIK"
    movlw 128
    movwf BPFH
    movlw 192
    f@call LCD@CRS
    ...
    f@call C@STROUT
ANAPROGRAM
F1_000029 equ $ ; IN [DISPLAY_4.BAS] GOTO ANAPROGRAM
    f@jump ANAPROGRAM
F1_EOF equ $ ; DISPLAY_4.BAS
_PBLB__2
    f@jump _PBLB__2
_STRLB__1
    de 77,69,82
