...
proton#main#start
    clrf STATUS
F1_SOF equ $ ; UYGULAMA_1.BAS
    movlw 7
    bsf STATUS,5
ram_bank = 1
    movwf ADCON1
    movwf CMCON
F1_000008 equ $ ; IN [UYGULAMA_1.BAS] TRISB = %00000001
    movlw 1
    movwf TRISB
F1_000009 equ $ ; IN [UYGULAMA_1.BAS] TRISD = %00000000
    clrf TRISD
ANAPROGRAM
    bcf STATUS,5
ram_bank = 0
F1_000014 equ $ ; IN [UYGULAMA_1.BAS] IF  PORTD.0 = 0 THEN
    set@page _LBL__3
    btfsc PORTD,0
    goto _LBL__3
F1_000015 equ $ ; IN [UYGULAMA_1.BAS] IF PORTB.0 = 1 THEN
    set@page _LBL__5
    btfss PORTB,0
    goto _LBL__5
F1_000016 equ $ ; IN [UYGULAMA_1.BAS] PORTD.0 = 1
    bsf PORTD,0
F1_000017 equ $ ; IN [UYGULAMA_1.BAS] ENDIF
_LBL__5
    f@jump _LBL__6
_LBL__3
F1_000018 equ $ ; IN [UYGULAMA_1.BAS] ELSE
F1_000019 equ $ ; IN [UYGULAMA_1.BAS] IF PORTB.0 = 1 THEN
    set@page _LBL__8
    btfss PORTB,0
    goto _LBL__8
F1_000020 equ $ ; IN [UYGULAMA_1.BAS] PORTD.0 = 0
    bcf PORTD,0
F1_000021 equ $ ; IN [UYGULAMA_1.BAS] ENDIF
_LBL__8
F1_000022 equ $ ; IN [UYGULAMA_1.BAS] ENDIF
_LBL__6
F1_000026 equ $ ; IN [UYGULAMA_1.BAS] GOTO ANAPROGRAM
    f@jump ANAPROGRAM
F1_EOF equ $ ; UYGULAMA_1.BAS
_PBLB__9
    f@jump _PBLB__9
__EOF
