...
proton#main#start
    clrf STATUS
F1_SOF equ $ ; UYGULAMA_2.BAS
    movlw 7
    bsf STATUS,5
ram_bank = 1
    movwf ADCON1
    movwf CMCON
F1_000010 equ $ ; IN [UYGULAMA_2.BAS] OUTPUT PORTD
    clrf TRISD
F1_000011 equ $ ; IN [UYGULAMA_2.BAS] INPUT PORTB.0
    bsf TRISB,0
ANAPROGRAM
    bcf STATUS,5
ram_bank = 0
F1_000015 equ $ ; IN [UYGULAMA_2.BAS] IF  PORTD.0 = 0 THEN
    set@page _LBL__3
    btfsc PORTD,0
    goto _LBL__3
F1_000016 equ $ ; IN [UYGULAMA_2.BAS] IF PORTB.0 = 1 THEN
    set@page _LBL__5
    btfss PORTB,0
    goto _LBL__5
F1_000017 equ $ ; IN [UYGULAMA_2.BAS] PORTD.0 = 1
    bsf PORTD,0
F1_000018 equ $ ; IN [UYGULAMA_2.BAS] DELAYMS 500
    movlw 1
    movwf PP1H
    movlw 244
    f@call __DELAY_MS_W_
F1_000019 equ $ ; IN [UYGULAMA_2.BAS] ENDIF
_LBL__5
    f@jump _LBL__6
_LBL__3
F1_000020 equ $ ; IN [UYGULAMA_2.BAS] ELSE
F1_000021 equ $ ; IN [UYGULAMA_2.BAS] IF PORTB.0 = 1 THEN
    set@page _LBL__8
    btfss PORTB,0
    goto _LBL__8
F1_000022 equ $ ; IN [UYGULAMA_2.BAS] PORTD.0 = 0
    bcf PORTD,0
F1_000023 equ $ ; IN [UYGULAMA_2.BAS] DELAYMS 500
    movlw 1
    movwf PP1H
    movlw 244
    f@call __DELAY_MS_W_
F1_000024 equ $ ; IN [UYGULAMA_2.BAS] ENDIF
_LBL__8
F1_000025 equ $ ; IN [UYGULAMA_2.BAS] ENDIF
_LBL__6
F1_000029 equ $ ; IN [UYGULAMA_2.BAS] GOTO ANAPROGRAM
    f@jump ANAPROGRAM
F1_EOF equ $ ; UYGULAMA_2.BAS
_PBLB__9
    f@jump _PBLB__9
__EOF
